...
st.markdown("예술의전당 회원 및 공연 입장객 데이터를 시각화한 대시보드입니다.")
...
with col2:
    st.info("💡 **SQL 쿼리**\n" + f"```sql\n{sql1}\n```")
    st.success("**인사이트**\n1. 회원 중 특정 성별의 비중을 통해 마케팅 타겟을 설정할 수 있습니다.\n2. 여성과 남성의 비율 차이에 따른 맞춤형 공연 기획이 필요합니다.")
...
with col2:
    st.info("💡 **SQL 쿼리**\n" + f"```sql\n{sql3}\n```")
    st.success("**인사이트**\n1. 2025년 가장 흥행한 작품과 해당 작품의 장르를 파악할 수 있습니다.\n2. 상위권에 포진된 장르(예: 클래식, 뮤지컬 등)의 선호도를 확인할 수 있습니다.")
